...
Keycloak 8089, API 3001. Frontend: `npm run dev` on **port 3000** — Keycloak's `academy-web` client
whitelists `http://localhost:3000/authentication` and nothing else, so a different port produces
