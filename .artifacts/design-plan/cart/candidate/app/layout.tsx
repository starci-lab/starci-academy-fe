 ...
 * catalogue, then hands both to a client boundary. The contexts themselves live in `providers.tsx`
 ...
 * fixture locale `vi` and imports the target's real `vi` catalogue. Every rendered state therefore
 * declares `locale: vi` rather than claiming locale coverage it does not have.
 */
