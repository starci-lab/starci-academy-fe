 ...
 * opened without the lab and so every rendered state is reachable from one place - including a state
 * the manifest forgot to list, which is the failure this page makes visible.
 */
const CandidateIndex = () => (
    <div className="mx-auto flex w-full max-w-app-lg flex-col gap-4 p-6">
        <h1 className="text-lg font-semibold text-foreground">learn-content-page · direction-b-one-spine · revision 1.0</h1>
