...
import { COMMON_GRAMMAR_COMPONENTS, COMMON_UI_RULE_IDS, Link, PRESENTATION_STATES, Sidebar, TextAction, WorkspaceShell, assertPresentationState, defineGrammarFamily, isPresentationState } from "../../dist/common/index.js"
...
test("owns the shared family base and canonical X-n catalog", () => {
    assert.equal(COMMON_GRAMMAR_COMPONENTS.Link, Link)
    assert.equal(typeof defineGrammarFamily, "function")
    assert.equal(COMMON_UI_RULE_IDS.length, 117)
})
