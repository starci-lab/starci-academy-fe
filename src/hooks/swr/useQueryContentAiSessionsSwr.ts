...
/** Lists the current viewer's conversations; an empty request means their global list. */
export const useQueryContentAiSessionsSwr = (request: QueryContentAiSessionsRequest = {}) => {
    const viewer = useViewerKey()
    return useSWR<ContentAiSessionsData | null>(
        viewer === undefined ? null : [QUERY_CONTENT_AI_SESSIONS_SWR_KEY, viewer, request],
