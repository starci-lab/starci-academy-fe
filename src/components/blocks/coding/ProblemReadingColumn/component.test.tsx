...
import { _ProblemReadingColumn, type ProblemReadingColumnData } from "./component"
...
describe("_ProblemReadingColumn", () => {
    it("keeps all four readings reachable and marks the open one", () => {
        render(<_ProblemReadingColumn state="ready" props={props} />)
    ...
    it("reports the reading the reader moved to", () => {
        ...
        render(<_ProblemReadingColumn state="ready" props={props} on={{ selectTab }} />)
    ...
    it("leaves the tabs inert when the page reported no reader for them", () => {
        render(<_ProblemReadingColumn state="ready" props={{ ...props, tags: [] }} on={{}} />)
    ...
    it("drops the tag run entirely when the problem carries no tags", () => {
        render(<_ProblemReadingColumn state="ready" props={{ ...props, tags: undefined }} />)
    ...
    it("rests the heading, the difficulty and the prose while the problem is in flight", () => {
        render(<_ProblemReadingColumn state="pending" props={{ tab: "statement", tabLabels }} />)
