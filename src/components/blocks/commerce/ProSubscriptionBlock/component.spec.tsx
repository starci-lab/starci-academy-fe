...
describe("ProSubscriptionBlockBase", () => {
    ...
    it("renders one signed-out offer with flush benefit bands and one joined disclosure surface", () => {
        ...
        expect(screen.getByText(labels.benefits[3]!.title)).toHaveClass("text-foreground")
        ...
        expect(screen.getByText(labels.benefits[3]!.description)).toHaveClass("data-[tone=muted]:text-muted")
        ...
        expect(screen.getByText(labels.aiTitle)).toHaveClass("text-foreground")
        ...
        expect(screen.getByText(labels.aiDescription)).toHaveClass("text-foreground")
