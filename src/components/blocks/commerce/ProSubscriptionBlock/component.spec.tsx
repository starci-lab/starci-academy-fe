...
describe("ProSubscriptionBlockBase", () => {
    ...
    it("renders one signed-out offer with flush benefit bands and one joined disclosure surface", () => {
        ...
        expect([...container.querySelectorAll("h1, h2, h3, h4")].map((heading) => heading.tagName))
        ...
        expect(screen.getByRole("heading", { level: 2, name: labels.disclosuresTitle })).toBeInTheDocument()
