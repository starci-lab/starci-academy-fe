...
export const PlaygroundSessionBase = (input: PlaygroundSessionBaseProps) => {
    ...
    return (
        <Tree contract="course-playground-session-workspace" render={defineContractComponent("course-playground-session-workspace", {
            ...
            ...(!settled ? {
                ...
                ...(sessionState !== "live" || current === undefined || input.props.passedStepIndexes.includes(input.props.selectedStepIndex) ? {} : {
