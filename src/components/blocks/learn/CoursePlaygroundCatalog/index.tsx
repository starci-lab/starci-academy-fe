...
export const CoursePlaygroundCatalog = (props: CoursePlaygroundCatalogProps) => {
    ...
    const failed = course.error !== undefined || course.data === null || playgrounds.error !== undefined || playgrounds.data === null; const rows = playgrounds.data ?? []
    return <CoursePlaygroundCatalogBase state={playgroundStateOf(failed, pending, rows.length === 0)} props={{ title: t("title"), description: t("description"), eyebrow: t("eyebrow"), verifiedLabel: t("verifiedLabel"), previewAlt: t("previewAlt"), previewImageUrl: course.data?.playgroundPreviewImageUrl, startLabel: t("startLabel"), labsTitle: t("labsTitle"), labsDescription: t("labsDescription"), labCountLabel: t("labCountLabel"), labLabel: t("labLabel"), stepLabel: t("stepLabel"), openLabel: t("openLabel"), emptyText: t("empty"), failedText: t("failed"), retryLabel: t("retry"), processTitle: t("processTitle"), processSteps: [t("processChoose"), t("processPair"), t("processVerify")], playgrounds: rows }} on={{ openSetup: (slug) => router.push(`/courses/${displayId}/learn/playground/${slug}`), retry: () => { void course.mutate(); void playgrounds.mutate() } }} />
}
