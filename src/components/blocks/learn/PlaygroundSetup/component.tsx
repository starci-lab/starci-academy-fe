...
export const PlaygroundSetupBase = (input: PlaygroundSetupBaseProps) => {
    ...
    return (
        <Tree contract="course-playground-setup-workspace" render={defineContractComponent("course-playground-setup-workspace", {
            header: defineLeafComponent("heading", {}, () => (
                <Heading
            ...
            ...(paired ? {
                ...
                status: defineLeafComponent("text", { size: "sm", tone: "muted" }, () => (
                    <Text
                        props={{
                            content: setupState === "ready" ? input.props.readyLabel : input.props.waitingLabel,
                            size: "sm",
                            tone: "muted",
                            live: "polite",
                        }}
