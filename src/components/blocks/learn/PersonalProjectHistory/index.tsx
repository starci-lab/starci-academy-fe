...
export const PersonalProjectHistory = (props: PersonalProjectHistoryProps) => {
    ...
    const labels: PersonalProjectHistoryLabels = locale === "vi" // vn-ok: localized Vietnamese runtime copy.
        ? {
            ...
            pending: "Đang tải lịch sử chấm...", empty: "Chưa có lần chấm nào.", failed: "Không thể tải lịch sử chấm.", // vn-ok: localized Vietnamese runtime copy.
        }
        : {
            ...
            pending: "Loading grading history...", empty: "No grading attempts yet.", failed: "Grading history could not be loaded.",
        }
