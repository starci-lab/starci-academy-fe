...
const LEARN_CONTENT_PAGE_CONTRACT = "learn-content-page" as const
import {
    contentTabRow,
    type ContentFaceId,
    type ContentFaceTab,
...
/**
 * PAGE - `CourseLearnContentBlock`: one content, read.
 *
 * Target path on materialization: `src/components/pages/CourseLearnContentBlock/component.tsx`.
 *
...
export type CourseLearnContentBlockLabels = {
...
export type CourseLearnContentBlockData = {
    readonly labels: CourseLearnContentBlockLabels
...
export type CourseLearnContentBlockActions = {
...
/** Props for {@link CourseLearnContentBlockBase}. */
export type CourseLearnContentBlockProps = {
    readonly blockState: CourseLearnContentBlockState
    readonly props: CourseLearnContentBlockData
    readonly on?: CourseLearnContentBlockActions
}
 ...
 */
export const CourseLearnContentBlockBase = (input: CourseLearnContentBlockProps) => {
    ...
    const isLocked = input.blockState === "locked"
    const hasFailed = input.blockState === "failed"
    ...
    if (input.props.mobileView === "lesson") {
        return <Tree contract={LEARN_CONTENT_PAGE_CONTRACT} render={reader} />
    }
