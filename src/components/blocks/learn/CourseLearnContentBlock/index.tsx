...
import {
    ...
    type CourseLearnContentBlockState,
} from "./component"
...
export interface CourseLearnContentBlockProps {
...
const contentStateOf = (pending: boolean, failed: boolean, locked: boolean): CourseLearnContentBlockState => {
