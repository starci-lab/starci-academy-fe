...
describe("JobReadinessWidgetBase", () => {
    it("draws the strongest-track headline, percentile, pillars and targeted CTA", () => {
        ...
        expect(container.querySelector("[data-part=\"readiness-headline\"]")).toHaveClass("bg-surface-secondary", "px-4", "pt-4", "pb-3", "sm:justify-between")
        expect(screen.getByText("Building")).toHaveAttribute("data-tone", "muted")
