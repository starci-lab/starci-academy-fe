...
import { streakFactClassName, streakNudgeClassName, streakPrimaryClassName, streakPromptClassName } from "./classNames"
...
export const StreakStripBase = (props: StreakStripProps) => {
    ...
    return (
        <SurfaceCard props={{ label: props.props.label }} isLoading={loading}>
            <div data-part="streak-primary" className={streakPrimaryClassName}>
                ...
                {active || loading ? (
                    ...
                    <div data-part="streak-prompt" className={streakPromptClassName}>
            ...
            {active && !today && props.state === "ready" ? (
                <div data-part="streak-nudge" className={streakNudgeClassName}>
