...
describe("OverviewJobReadiness", () => {
    ...
    it("nests the metric list inside the readiness surface", () => {
        ...
        expect(container.textContent).not.toContain("64% · Backend track")
        expect(readinessSurface).toHaveAttribute("data-grammar-surface-composition", "single")
        expect(readinessSurface?.firstElementChild).toHaveAttribute("data-grammar-surface-content", "true")
