...
export type ProfileProjectRoadmapBlockProps = { readonly state: "pending" | "ready" | "error"; readonly project?: ProfileCapstone; readonly onBack: () => void }

/** Draw capstone summary/progress above its ordered milestone roadmap. */
export const ProfileProjectRoadmapBase = ({ state, project, onBack }: ProfileProjectRoadmapBlockProps) => {
