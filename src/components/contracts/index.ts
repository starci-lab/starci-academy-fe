...
export const CONTRACTS = buildContracts({
    ...
    "course-personal-project-task-page": {
        ...
        why: "if you need a project task's brief, score constraint and single submission action in one bounded vertical decision below its title.",
    },
    ...
    "flashcard-review-deck-card": {
        ...
        why: "if you need one comparable deck offer card: identity, explanation, card counts, then one start action.",
    },
    ...
    "flashcard-session-card": {
        ...
        why: "if you need the single focused prompt/answer surface a live flashcard session reveals one card at a time.",
    },
