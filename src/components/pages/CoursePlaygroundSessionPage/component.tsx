...
export const CoursePlaygroundSessionPageShell = ({ displayId, slug }: CoursePlaygroundSessionRouteProps) => <Tree contract="course-playground-session-page" render={defineContractComponent("course-playground-session-page", { content: defineContractProjection("course-playground-session-workspace", () => <PlaygroundSession displayId={displayId} slug={slug} />) })} />
