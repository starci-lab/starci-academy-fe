...
export const ProfileProjectRoadmapPage = () => {
    ...
    return <ProfileProjectRoadmapPageBase state={query.error ? "error" : query.isLoading || profile.isLoading ? "pending" : "ready"} project={project} onBack={() => router.push(`/profile/${username}/projects`)} />
}
