...
export const CourseMockInterviewSessionPage = (props: CourseMockInterviewSessionPageProps) => {
    ...
    return (
        <CourseMockInterviewSessionPageBase
            ...
            currentLabel={locale === "vi" ? "Phỏng vấn" : "Interview"} // vn-ok: localized runtime breadcrumb copy
