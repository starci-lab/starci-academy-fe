...
describe("LeaguePage route", () => {
    ...
    it("settles the global board with its own ranking data", () => { m.scope = "global"; m.global.data = { myRank: 5, myPoints: 50, entries: [{ userGlobalId: "gid://User/2", username: "Other", rank: 1, points: 100, avatar: null, isFollowing: false }] }; render(<LeaguePage />); expect(screen.getByTestId("state")).toHaveTextContent("ready") })
})
