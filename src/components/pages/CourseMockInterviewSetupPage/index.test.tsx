...
const m = vi.hoisted(() => ({ data: undefined as any, error: undefined as any, mutate: vi.fn(), push: vi.fn() }))
...
vi.mock("./component", () => ({ _CourseMockInterviewSetupPage: ({ state }: any) => <output data-testid="state">{state}</output> }))
