...
export type PersonalProjectGradingSettingsDrawerProps = { readonly courseId: string; readonly taskId: string; readonly repositoryUrl?: string; readonly isOpen: boolean; readonly onDismiss: () => void }
