...
const iconOnly = { base: cn("inline-flex", "size-11", "shrink-0", "items-center", "justify-center", "rounded-full", "p-0", "text-muted"), current: cn("inline-flex", "size-11", "shrink-0", "items-center", "justify-center", "rounded-full", "bg-accent-soft", "p-0", "text-accent-soft-foreground") } as const
