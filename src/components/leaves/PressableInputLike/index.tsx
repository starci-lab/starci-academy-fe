...
export const PressableInputLike = ({ props, on }: PressableInputLikeProps) => (
    <Button
        ...
        onPress={on?.press}
        className="h-9 min-h-9 w-[260px] justify-between gap-2 rounded-field border border-default bg-field px-3 font-normal text-field-foreground shadow-[var(--field-shadow)] hover:bg-field"
    >
