...
/** SVG attributes accepted by the Google provider mark. */
export type GoogleMarkProps = SVGProps<SVGSVGElement>
/** SVG attributes accepted by the GitHub provider mark. */
export type GithubMarkProps = SVGProps<SVGSVGElement>

/** Google's mark, in Google's colours. */
export const GoogleMark = (props: GoogleMarkProps) => (
...
export const GithubMark = (props: GithubMarkProps) => (
