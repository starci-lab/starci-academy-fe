 ...
 *
 * Every other glyph in this vocabulary comes from Phosphor, sized by class and inheriting the
...
/** The size step a brand mark is drawn at, matching the Phosphor glyphs beside it. */
const BRAND_CLASSES = "size-4 shrink-0"

/** Google's mark, in Google's colours. */
export const GoogleMark = () => (
    <svg className={BRAND_CLASSES} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
        <path
...
export const GithubMark = () => (
    <svg className={BRAND_CLASSES} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
