...
/** Calendar grid. */
export const contributionGridClassName = cn("flex", "w-full", "flex-row", "items-stretch", "gap-1")
/** Weekday column: dropped below the wide rail so a narrow drag surface keeps its full year visible. */
export const contributionWeekdayColumnClassName = cn("flex", "w-12", "shrink-0", "flex-col", "gap-1", "pr-1", "max-lg:hidden")
...
/** Calendar week. */
export const contributionWeekClassName = cn("flex", "min-w-0", "flex-1", "flex-col", "gap-1")
/** Month label. */
