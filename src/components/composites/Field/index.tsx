...
export type FieldData = { readonly id: string; readonly name: string; readonly label: string; readonly labelVisibility?: "visible" | "screenReader"; readonly description?: string; readonly kind?: FieldKind; readonly placeholder?: string; readonly defaultValue?: string; readonly hint?: string; readonly isInvalid?: boolean; readonly disabled?: boolean; readonly revealLabel?: string; readonly hideLabel?: string }
