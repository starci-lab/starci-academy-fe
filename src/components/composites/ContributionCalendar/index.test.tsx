...
describe("ContributionCalendar", () => {
    it("draws the whole year, selector, intensity key and streak caption", () => {
        ...
        expect(screen.getByText("2026").closest("[data-component=\"TextLink\"]")).toHaveAttribute("data-selected", "true")
        expect(screen.getByText("2025").closest("[data-component=\"TextLink\"]")).toHaveAttribute("data-size", "sm")
