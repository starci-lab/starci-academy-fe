# Visual audit — Profile projects route

## Owner

- Kind: page
- Source refs: src/app/[lang]/profile/[username]/projects/page.tsx
- Entry context: Profile projects tab
...
- Reason why: Historical Projects 9/10 is invalid and noncanonical after explicit owner rejection; fresh final visual capture was blocked at DPR preflight for wide CSS1600x900 and compact CSS390x843, so no current raster can support a numeric or typed visual verdict.
- Covered evidence: two supplied screenshots are visually duplicate captures of `/vi/profile/cuongnvtse160875/projects`, not independent page coverage; final frozen source and gate receipt only; no rasters accepted; single Ctrl+0 retry also blocked and leases released
...
- Remaining gaps: fresh wide CSS1600x900 and compact CSS390x843 rasters at DPR 0.800000011920929; preflight remains blocked; no reconstruction authorization
...
- 2026-08-31 · Round 1 · INSUFFICIENT_EVIDENCE · N/A · Empty state recaptured successfully; closure matrix and blind verdict remain incomplete.
...
- Coverage: wide 1440, compact 390, compact 312 rail; collection lifecycle, row activation, and tab navigation.
- Disposition: direct Projects route passed latest visual closure.
