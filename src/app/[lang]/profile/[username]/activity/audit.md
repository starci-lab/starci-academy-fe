# Visual audit — Profile activity route

## Owner

- Kind: page
- Source refs: src/app/[lang]/profile/[username]/activity/page.tsx
- Entry context: Profile activity tab
...
- Disposition: direct Activity route passed latest visual closure.
